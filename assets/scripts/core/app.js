...
var App = function () {
    ...
    var handleTheme = function () {
        ...
        // handle theme colors
		// masih belum ketemu caranya selain menambahkan ini : "http://localhost/sia/application/views/"
        var setColor = function (color) {
            var color_ = (App.isRTL() ? color + '-rtl' : color);
            $('#style_color').attr("href", "http://localhost/sia/application/views/assets/css/themes/" + color_ + ".css");
            if ($.cookie) {                
