    ...
    var handleInvoices = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "iDisplayLength": 20,
                "bServerSide": true,
                "sAjaxSource": "http://localhost/sia/application/views/demo/ecommerce_order_invoices.php",
    ...
    var handleCreditMemos = function () {
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "iDisplayLength": 10,
                "bServerSide": true,
                "sAjaxSource": "http://localhost/sia/application/views/demo/ecommerce_order_credit_memos.php",
    ...
    var handleShipment = function () {
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "iDisplayLength": 10,
                "bServerSide": true,
                "sAjaxSource": "http://localhost/sia/application/views/demo/ecommerce_order_shipment.php",
                "aoColumnDefs" : [{  // define columns sorting options(by default all columns are sortable extept the first checkbox column)
                    'bSortable' : true
                }],
                "aaSorting": [[ 0, "asc" ]] // set first column as a default sort by asc
    ...
    var handleHistory = function () {
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "iDisplayLength": 20,
                "bServerSide": true,
                "sAjaxSource": "http://localhost/sia/application/views/demo/ecommerce_order_history.php",
                "aoColumnDefs" : [{  // define columns sorting options(by default all columns are sortable extept the first checkbox column)
                    'bSortable' : true
                }],
                "aaSorting": [[ 0, "asc" ]] // set first column as a default sort by asc
