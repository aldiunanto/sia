var EcommerceProductsEdit = function () {
    ...
    var handleImages = function() {
        ...
        var uploader = new plupload.Uploader({
            ...
            url : "http://localhost/sia/application/views/assets/plugins/plupload/examples/upload.php",
            ...
            // Flash settings
            flash_swf_url : 'http://localhost/sia/application/views/assets/plugins/plupload/js/Moxie.swf',
     
            // Silverlight settings
            silverlight_xap_url : 'http://localhost/sia/application/views/assets/plugins/plupload/js/Moxie.xap',             
    ...
    var handleReviews = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "iDisplayLength": 20,
                "bServerSide": true,
                "sAjaxSource": "http://localhost/sia/application/views/demo/ecommerce_product_reviews.php",
    ...
    var handleHistory = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "iDisplayLength": 20,
                "bServerSide": true,
                "sAjaxSource": "http://localhost/sia/application/views/demo/ecommerce_product_history.php",
                "aoColumnDefs" : [{  // define columns sorting options(by default all columns are sortable extept the first checkbox column)
                    'bSortable' : true
                }],
                "aaSorting": [[ 0, "asc" ]] // set first column as a default sort by asc
