	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					<h3 class="page-title">
					Customers <small>add new customers</small>
					</h3>
				...
				<div class="col-md-12">
					<div class="portlet box blue" id="form_wizard_1">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i> Add Customer -
						...
						<div class="portlet-body form">
							...
							<form action="<?php echo site_url('customers/store') ?>" class="form-horizontal" id="submit_form" method="post">
										...
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab1">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<div class="radio-list">
															<label>
															<input type="radio" name="cust_business" value="1" data-title="Manufacture"/>
															Manufacture </label>
															<label>
															<input type="radio" name="cust_business" value="2" data-title="Distributor"/>
															Distributor </label>
															<label>
															<input type="radio" name="cust_business" value="3" data-title="Retailer"/>
															Retailer </label>
														</div>
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="cust_product"/>
														<span class="help-block">
											...
											<div class="tab-pane" id="tab2">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="cust_pers"/>
														<span class="help-block">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="cust_persposition"/>
														<span class="help-block">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="cust_phone1"/>
														<span class="help-block">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="cust_phone2"/>
														<span class="help-block">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="cust_fax1"/>
														<span class="help-block">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="cust_fax2"/>
														<span class="help-block">
												...
												<div class="form-group">
													...
													<div class='col-md-3'>
														<div class="input-group">
															<input type="text" class="form-control timepicker timepicker-no-seconds" name="cust_open" readonly="readonly">
												...
												<div class="form-group">
													...
													<div class='col-md-3'>
														<div class="input-group">
															<input type="text" class="form-control timepicker timepicker-no-seconds" name="cust_close" readonly="readonly">
															<span class="input-group-btn">
																<button class="btn default" type="button"><i class="fa fa-clock-o"></i></button>
															</span>
														</div>
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="cust_zipcode"/>
														<span class="help-block">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<select name="cust_reg" id="country_list" multiple class="form-control">
															...
															<option value="<?php echo $row->reg_id ?>"><?php echo $row->reg_name ?></option>
															<?php endforeach; ?>
														</select>
													</div>
												</div>
											...
											<div class="tab-pane" id="tab3">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="cust_npwp"/>
														<span class="help-block">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<textarea class="form-control" rows="3" name="cust_remarks"></textarea>
													</div>
												</div>
											</div>
