				...
				<div class="col-md-12">
					<div class="portlet box blue" id="form_wizard_1">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i> Add Account -
						...
						<div class="portlet-body form">
							<form action="<?php echo site_url('sales/store') ?>" class="form-horizontal" id="submit_form" method="post">
										...
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab1">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="sales_username"/>
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="password" class="form-control" name="sales_pwd" id="sales_pwd"/>
														<span class="help-block">
															 Provide sales password.
														</span>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="password" class="form-control" name="sales_cpwd"/>
														<span class="help-block">
															 Confirm sales password
														</span>
													</div>
												</div>
												<div class="form-group">
											...
											<div class="tab-pane" id="tab2">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="sales_fname"/>
														<span class="help-block">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="sales_lname"/>
														<span class="help-block">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<div class="radio-list">
															<label>
															<input type="radio" name="sales_gender" value="M" data-title="Male"/>
															Male </label>
															<label>
															<input type="radio" name="sales_gender" value="F" data-title="Female"/>
															Female </label>
														</div>
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<textarea class="form-control" rows="3" name="sales_about"></textarea>
													</div>
												</div>
											</div>
